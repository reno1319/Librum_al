...
// this codebase's every other permission-driven surface.
//
// ADMIN-1C PART C: Audit log added, gated by audit.view -- the same
// permission src/app/admin/(protected)/audit/page.tsx itself requires.
